...
impl RustCtx {
    ...
    pub async fn build(&self, cargoflags: &[String], rustflags: &str) -> cu::Result<bool> {
        ...
        let mut command = cargo
            ...
            .preset(cu::pio::cargo("Building mod crate"));
        ...
        // Panic if we cant find the .a file that should exist be now or
        // if we can't access its mtime
    ...
    fn get_source_files(&self) -> cu::Result<Vec<PathBuf>> {
        // IDEA: try to make this return an iterator
