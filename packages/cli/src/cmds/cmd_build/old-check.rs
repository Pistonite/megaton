...
use regex::Regex;
use crate::{cmds::cmd_build::{BTArtifacts, config::{Build, Module, Check}}, env::environment};


/// Check the ELF for issues with symbols and instructions
pub struct CheckPhase {
    btart: Rc<BTArtifacts>,
    config: Rc<Check>,
}
