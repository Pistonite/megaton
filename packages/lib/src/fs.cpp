...
//         // nnheaders OpenOption definition: hettps://github.com/open-ead/nnheaders/blob/0547381a6166ea54fb306a53a02683a8527475fd/include/nn/fs/fs_types.h#L51
...
//         fd.seek_pos += len;
//         if(result.IsFailure()) {
//             botw::tcp::sendf("sys_write: nn::fs::WriteFile failed! Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//         }
//     }
...
//         if (result.IsFailure()) {
//             botw::tcp::sendf("Library sys_open: nn::fs::CreateFile failed! Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//             return -EIO;
//         }
...
//         uint32_t open_mode = impl::hermit_to_nn_flags(flags);
//         nn::fs::FileHandle inner;
//         result = nn::fs::OpenFile(&inner, name, open_mode);
//         if (result.IsFailure()) {
//             botw::tcp::sendf("Library sys_open: nn::fs::OpenFile failed! Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//             return -EIO;
//         }
...
//             if(result.IsFailure()) {
//                 botw::tcp::sendf("sys_read: nn::fs::ReadFile failed! Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//                 return -EIO;
//             }
...
//     if(result.IsFailure()){
//         botw::tcp::sendf("Library: sys_unlink: nn::fs::GetEntryType failed with Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
...
//             if(result.IsFailure()){
//                 botw::tcp::sendf("Library: sys_unlink: nn::fs::DeleteFile failed with Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//                 return -1;
//             }
//             break;
//         }
...
//             if(result.IsFailure()){
//                 botw::tcp::sendf("Library: sys_unlink: nn::fs::DeleteDirectory failed with Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//                 return -1;
//             }
//             break;
//         }
...
//     nn::Result result = nn::fs::GetEntryType(&type, name);
//     if (result.IsFailure()) {
//         botw::tcp::sendf("library sys_stat: nn::fs::GetEntryType returned Failure result %s (%d)\n", result.GetDescription());
//         return -1;
//     }
...
//         if(result.IsFailure()){
//             botw::tcp::sendf("Library: sys_stat: nn::fs::OpenFile failed with Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//             return -1;
//         }
...
//         if(result.IsFailure()){
//             botw::tcp::sendf("Library: sys_stat: nn::fs::OpenDirectory failed with Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
...
//     if(result.IsFailure()) {
//         botw::tcp::sendf("Library: sys_mkdir failed! Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//         return -1;
//     }
...
//     if(result.IsFailure()) {
//         botw::tcp::sendf("Library: sys_opendir failed! Error: module=%d, description=%d\n", result.GetModule(), result.GetDescription());
//         return -1;
//     }
//     FileDescriptor fd = create_fd_dir(inner._internal);
