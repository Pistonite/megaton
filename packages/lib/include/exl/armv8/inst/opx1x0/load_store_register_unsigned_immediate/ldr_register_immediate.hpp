...
struct LdrRegisterImmediate
    : public impl::opx1x0::InsnLoadStoreRegisterUnsignedImmediate {
    ...
    constexpr LdrRegisterImmediate(reg::Register rt, reg::Register rn,
                                   u16 imm12 = 0)
        : InsnLoadStoreRegisterUnsignedImmediate(GetSize(rt), V, Opc, imm12, rn,
                                                 rt) {}
};
...
static_assert(LdrRegisterImmediate(reg::X14, reg::X15, 4).Value() == 0xF94011EE,
              "");
static_assert(LdrRegisterImmediate(reg::W16, reg::X17, 20).Value() ==
                  0xB9405230,
              "");
static_assert(LdrRegisterImmediate(reg::W18, reg::X19, 52).Value() ==
                  0xB940D272,
              "");
static_assert(LdrRegisterImmediate(reg::W20, reg::X21, 41).Value() ==
                  0xB940A6B4,
              "");
static_assert(LdrRegisterImmediate(reg::W22, reg::X23, 75).Value() ==
                  0xB9412EF6,
              "");
static_assert(LdrRegisterImmediate(reg::W24, reg::X25, 95).Value() ==
                  0xB9417F38,
              "");
static_assert(LdrRegisterImmediate(reg::W26, reg::X27, 69).Value() ==
                  0xB941177A,
              "");
