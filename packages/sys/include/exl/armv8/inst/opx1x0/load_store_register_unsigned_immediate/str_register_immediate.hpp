...
struct StrRegisterImmediate
    ...
    constexpr StrRegisterImmediate(reg::Register rt, reg::Register rn,
                                   u16 imm12 = 0)
...
static_assert(StrRegisterImmediate(reg::X14, reg::X15, 4).Value() == 0xF90011EE,
              "");
static_assert(StrRegisterImmediate(reg::W16, reg::X17, 20).Value() ==
                  0xB9005230,
              "");
static_assert(StrRegisterImmediate(reg::W18, reg::X19, 52).Value() ==
                  0xB900D272,
              "");
static_assert(StrRegisterImmediate(reg::W20, reg::X21, 41).Value() ==
                  0xB900A6B4,
              "");
static_assert(StrRegisterImmediate(reg::W22, reg::X23, 75).Value() ==
                  0xB9012EF6,
              "");
static_assert(StrRegisterImmediate(reg::W24, reg::X25, 95).Value() ==
                  0xB9017F38,
              "");
static_assert(StrRegisterImmediate(reg::W26, reg::X27, 69).Value() ==
                  0xB901177A,
              "");
