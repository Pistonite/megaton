...
use crate::config_file::ProjectTargetEnv;
...
pub trait Resolve {
    ...
    ///
    /// Toolchain maybe optional if the caller decides to not resolve the toolchain
    /// environment. The implementation can either pick default values or bail
