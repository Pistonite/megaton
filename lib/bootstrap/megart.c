...
__attribute__((used))
const module_name_t s_module_name = {
    .unknown = 0, 
...
const u8* __megaton_module_name() {
    return MEGART_NX_MODULE_NAME;
}

u32 __megaton_module_name_len() {
    return MEGART_NX_MODULE_NAME_LEN;
}

u64 __megaton_title_id() {
    return MEGART_TITLE_ID;
}

const u8* __megaton_title_id_hex() {
    return MEGART_TITLE_ID_HEX;
}
